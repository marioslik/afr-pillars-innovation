...
function init() {
    ...
    $('.frame-4 p').html('DISCOVER THE<br>LEADING<br>TECHNOLOGY AND<br>BUSINESS NEWS')
...
function start() {
    ...
    function featureAnimation() {
        tlFeature.set('.feature', {x:0})
                 .set('.eye', {alpha:0})
                 .set('#droid-1', {scale:1, transformOrigin:"100% 0%", x:50})
                 .set('#droid-2', {scale:1, transformOrigin:"100% 0%", x:50})
                 .set('#droid-3', {scale:1, transformOrigin:"100% 0%", x:50})
                 .set('#droid-4', {scale:1, transformOrigin:"100% 0%", x:50})

                 .to('.feature', 0.5, {ease:Power1.easeOut, y:-220, rotation:0})
